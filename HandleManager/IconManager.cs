...
public static class IconManager {
        ...
        icon = ToImageSource(
            ExtractVistaIcon(
                IconReader.GetFileIcon(
                    fileName, large ? IconReader.IconSize.Large : IconReader.IconSize.Small,
                    false)));
    ...
    public static Bitmap ExtractIcon(Icon icoIcon, int size) {
        Bitmap bmpPngExtracted = null;
        try {
            byte[] srcBuf = null;
            using (System.IO.MemoryStream stream = new System.IO.MemoryStream()) { icoIcon.Save(stream); srcBuf = stream.ToArray(); }
    ...
    public static extern uint ExtractIconEx(string lpszFile, int nIconIndex, ref int phiconLarge, ref int phiconSmall, uint nIcons);
