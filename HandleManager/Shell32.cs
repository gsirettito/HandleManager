...
namespace SiretT.Shell.Interop {
    ...
    class Shell32 {
        ...
        public extern static int ExtractIconEx(string lpszFile, int nIconIndex,
                    ref int phiconLarge, ref int phiconSmall, uint nIcons);

        [DllImport("shell32.dll")]
        public extern static IntPtr ExtractIcon(int hInst,
                        string lpszExeFileName, int nIconIndex);

        [DllImport("user32.dll")]
        public extern static int GetClassLong(IntPtr hWnd, int nIndex);
        ...
        [DllImport("shell32.dll")]
        public static extern IntPtr SHGetFileInfo(string lpzPath,
            int dwFileAttributes, out SHFILEINFO psfi, int cbFileInfo,
            SHGFI uFlags);
        ...
        [DllImport("shell32.dll")]
        public static extern HResult SHGetNewLinkInfo(
            [In] string pszLinkTo,
            [In] string pszDir,
            [Out] string pszName,
            [Out] bool pfMustCopy,
